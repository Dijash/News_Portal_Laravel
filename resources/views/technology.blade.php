...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl sm:text-4xl font-bold mb-6 sm:mb-8">Technology News</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse($news as $article)
            <article class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                ...
                @endif
                <div class="p-4">
                    <span class="inline-block bg-purple-500 text-white text-xs px-3 py-1 rounded-full mb-2">Technology</span>
        ...
        @empty
            <p class="text-gray-500 col-span-full">No technology news available.</p>
        @endforelse
    </div>
</div>
@endsection